...
module.exports = ({ config }) => {
  ...
  const androidPackage = isMarket ? 'com.khaleefah.ikm.market' : 'com.khaleefah.ikm.seller';
  const iosBundleIdentifier = isMarket ? 'com.khaleefah.ikm.market' : 'com.khaleefah.ikm.seller';
  ...
  const easProjectId =
    (isMarket ? process.env.EAS_PROJECT_ID_MARKET : process.env.EAS_PROJECT_ID_SELLER) ||
    extra?.eas?.projectId;
